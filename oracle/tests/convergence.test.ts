...
describe('State Convergence', () => {
    ...
    beforeAll(async () => {
        // Both use MOS 1.20:
        // - jsbeeb B-DFS1.2: Model B with 8271 disc controller + DFS ROM
        // - Beebium Model B: No disc controller (optional add-on)
        // The MOS is identical, so core behavior should match.
        // Disc hardware differences may cause some divergence in I/O areas.
